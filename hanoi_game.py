...
class HanoiEngine:
    ...
    def __init__(self, canvas, nrOfDiscs, speed, moveCntDisplay=None):
        ...
        self.running = False
        self.moveCnt = 0
        self.discs = [Disc(canvas) for i in range(15)]
    ...
    def run(self):
        ...
        self.running = True
        helper.play_hanoi(self, self.nrOfDiscs,
...
class Hanoi:
    ...
    def adjust_speed(self, e):
        ...
        self.hEngine.speed = self.tempo.get() % 1000
    ...
    def __init__(self, nrOfDiscs, speed):
        ...
        self.discsLbl = Label(attrFrame, width=7, height=15, font=fnt,
                              text="discs:\n")
        self.discs = Scale(attrFrame, from_=1, to_=15, orient=HORIZONTAL,
                           font=fnt, length=75, showvalue=1, repeatinterval=15,
                           command=self.adjust_nr_of_discs)
        self.discs.set(nrOfDiscs)
        self.tempoLbl = Label(attrFrame, width=8,  height=15, font=fnt,
                              text = "   speed:\n")
        self.tempo = Scale(attrFrame, from_=1, to_=1000, orient=HORIZONTAL,
                           font=fnt, length=100, showvalue=1,repeatinterval=15,
